classdef QMol_test_TDSE_abs_CAP < QMol_test
%QMol_test_TDSE_abs_CAP suite of unit tests for QMol_TDSE_abs_CAP
...
function showInfo
    fprintf('  * QMol_test_TDSE_abs_CAP\n'); 
    QMol_test_TDSE_abs_CAP.version;
end
end
%% Run tests%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%runTest unit tests for the class
    ...
    % Create mask
    abc                 =   QMol_TDSE_abs_CAP('length',[exp(2) log(100)]);
...
%runApplyGobbler unit tests for the application of the gobbler
    ...
    abc                 =   QMol_TDSE_abs_CAP('length',[8 8]);
    abc.initialize(SE,true);
