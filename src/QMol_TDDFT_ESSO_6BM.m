classdef QMol_TDDFT_ESSO_6BM < QMol_TDDFT_ESSO
%QMol_TDDFT_ESSO_6BM 6th order Blanes and Moan optimized symplectic split-
%   operator scheme
...
%   for the Strang splitting propagator
    ...
    obj.t_              =   t;
    obj.setExpT(QMol_cte.symp_6BMn_a1);
...
%applyTimeStep applies one iteration of propagator
    ...
    % Time propagation
    obj.chiFchiB([QMol_cte.symp_6BMn_a1  QMol_cte.symp_6BMn_a2  QMol_cte.symp_6BMn_a3 ],-1);
    obj.chiFchiB([QMol_cte.symp_6BMn_a3  QMol_cte.symp_6BMn_a4  QMol_cte.symp_6BMn_a5 ], 0);
    obj.chiFchiB([QMol_cte.symp_6BMn_a5  QMol_cte.symp_6BMn_a6  QMol_cte.symp_6BMn_a7 ], 0);
    obj.chiFchiB([QMol_cte.symp_6BMn_a7  QMol_cte.symp_6BMn_a8  QMol_cte.symp_6BMn_a9 ], 0);
    obj.chiFchiB([QMol_cte.symp_6BMn_a9  QMol_cte.symp_6BMn_a10 QMol_cte.symp_6BMn_a11], 0);
    obj.chiFchiB([QMol_cte.symp_6BMn_a11 QMol_cte.symp_6BMn_a12 QMol_cte.symp_6BMn_a13], 0);
    obj.chiFchiB([QMol_cte.symp_6BMn_a13 QMol_cte.symp_6BMn_a14 QMol_cte.symp_6BMn_a15], 0);
    obj.chiFchiB([QMol_cte.symp_6BMn_a15 QMol_cte.symp_6BMn_a16 QMol_cte.symp_6BMn_a17], 0);
    obj.chiFchiB([QMol_cte.symp_6BMn_a17 QMol_cte.symp_6BMn_a18 QMol_cte.symp_6BMn_a19], 0);
    obj.chiFchiB([QMol_cte.symp_6BMn_a19 QMol_cte.symp_6BMn_a20                       ], 1);
