classdef QMol_test_DFT_Vh_fft < QMol_test
%QMol_test_DFT_Vh_fft suite of unit tests for QMol_DFT_Vh_fft
...
function showInfo
    fprintf('  * QMol_test_DFT_Vh_fft\n'); 
    QMol_test_DFT_Vh_fft.version;
end
end
%% Run tests%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%runSpinRestricted unit tests for spin-restricted DFT
    ...
    Vext                =   QMol_DFT_Vext;
    Vh                  =   QMol_DFT_Vh_fft('interactionPotential',Vee);
    DFT                 =   QMol_DFT_spinRes(...
                                'xspan',                -15:.1:20,          ...
                                'occupation',           [5 5 1.3],          ...
                                'externalPotential',    Vext,               ...
                                'HartreePotential',     Vh);
    Vh.set('ghostLength',numel(DFT.xspan),'ghostUnit','points','addFalloffLength',true,...
