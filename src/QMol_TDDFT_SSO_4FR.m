classdef QMol_TDDFT_SSO_4FR < QMol_TDDFT_SSO
%QMol_TDDFT_SSO_4FR symplectic split-operator TDDFT propagator using a
...
%   for the Strang splitting propagator
    ...
    if ~isempty(obj.DFT.Vks.Vimp)
        ...
        error('QMol:TDDFT:SSOForestRuth:implicitPotential', ...
            'The Forest-Ruth propagator does not support implicit Kohn-Sham potentials');
    end
