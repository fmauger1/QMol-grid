classdef QMol_DFT_spinRes < QMol_DFT
%QMol_DFT_spinRes implementation of spin-restricted (SR) density-functional
%   theory (DFT) discretization on a Cartesian grid. It 
%   > overloads the QMol_DFT class to implement the SR-DFT model
...
%   01.22.000   04/30/2025  F. Mauger
%       Make getDiscCopy accessible to QMol_CI

%% Documentation %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
methods (Static,Access=private)
function version
    QMol_doc.showVersion('01.22.000','04/30/2025','F. Mauger')
end
end
methods (Static,Access={?QMol_doc,?QMol_DFT})
function showInfo
    fprintf('  * QMol_DFT_spinRes:\n      > 1D spin-restricted DFT\n'); 
    QMol_DFT_spinRes.version;
end
end
...
%   of the DFT model
    ...
    fprintf('  * Density-functional theory (DFT)                   spin restricted (SR)\n');
    fprintf('    SR-DFT level of theory, using the Kohn-Sham formalism [Kohn 1695].\n');
    obj.version;
...
methods (Hidden,Access = {?QMol_DFT,?QMol_CI})
