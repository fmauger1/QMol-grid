...
case {'init','initialize','initialization'} %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if isa(obj.sF,'function_handle')
        ...
        R               =   obj.sF(obj.SE.wfcn,obj.tspan(1));
        ...
        if obj.oF.ind(1) == 1
            ...
            % Update next to save
            if isscalar(obj.oF.ind),        obj.oF.n    =  -1;              % done with output function of density
            else,                           obj.oF.n    =   2;              end
...
otherwise %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    % Unexpected option
    error('QMol:TDSE:setOutputfunction',['Unknown option ' opt]);
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
end