...
%test_DFT_miscellaneous unit tests for miscellaneous DFT methods
    ...
    Vks                 =   QMol_DFT_Vks_basis;
    Vks1                =   QMol_DFT_Vks_basis('V',V1);
    Vks2                =   QMol_DFT_Vks_basis('V',V2);
    Vks3                =   QMol_DFT_Vks_basis('V',V3);
    ...
    Vks                 =   QMol_DFT_Vks_basis('V',[],'Vup',[],'Vdw',[]);
    Vks1                =   QMol_DFT_Vks_basis('V',[],'Vup',V1,'Vdw',V2);
    Vks2                =   QMol_DFT_Vks_basis('V',[],'Vup',V3,'Vdw',V4);
    Vks3                =   QMol_DFT_Vks_basis('V',[],'Vup',V5,'Vdw',V6);
    ...
    p                   =   rand(randStr,[size(v,2) 1],'like',1i);
    ...
    obj.showResult('DFT_randomOrbital',R);
    ...
    Vks2                =   QMol_DFT_Vks_basis('V',[],'Vup',V3,'Vdw',V4);
    Vks3                =   QMol_DFT_Vks_basis('V',[],'Vup',V5,'Vdw',V6);
    Vks4                =   QMol_DFT_Vks_basis('V',[],'Vup',V7,'Vdw',V8);
    ...
    obj.showResult('DFT_sizeOrbital',all(d_SR.DFT_sizeOrbital == [size(v,2) 1]));
