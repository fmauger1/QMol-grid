classdef QMol_test_DFT_orbital_basis < QMol_test
%QMol_test_DFT_orbital_basis suite of unit tests for QMol_DFT_orbital_basis
...
function showInfo
    fprintf('  * QMol_test_DFT_orbital_basis\n'); 
    QMol_test_DFT_orbital_basis.version;
end
end
%% Run tests%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%test_operator unit tests for operator overload in the class
    ...
    % Spin restricted
    R                   =   rand(15,7);
    V1                  =   QMol_DFT_orbital_basis('isSpinPol',false,'orbital',R);
    V2                  =   QMol_DFT_orbital_basis('isSpinPol',false,'orbital',R + .5e-10);
