...
![Version](https://img.shields.io/badge/version-v1.23.000-blue)
...
## Installation
The `QMol-grid` package can be installed directly from MATLAB (preferred) or this GitHub repository.
